...
import { newUserSchema, updatedUserSchema, searchParamsSchema } from "../models/users.models";
import asynchandler from "express-async-handler";
export const userRoutes = express.Router();

userRoutes.get("/users", celebrate({ [Segments.QUERY]: searchParamsSchema }), asynchandler(UsersController.search));
